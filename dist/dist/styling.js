...
function openCommandPalette() {
    ...
    dialog("Select a command: ", [
        ...
        { name: "Create new file", func: function () {
        ...
        { name: "Rename Current File", func: function () {
                return __awaiter(_this, void 0, void 0, function () {
                    var rename;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
        ...
        { name: "Developer Mode: ".concat(developerMode ? 'On' : "Off"), func: function () {
                return __awaiter(_this, void 0, void 0, function () {
                    var data;
                    return __generator(this, function (_a) {
